...
@Data
public class DetalheDespesaCadastrarRequest {

    @NotNull(message = "O campo 'idDespesa' não pode ser nulo")
    private Long idDespesa;

    @NotNull(message = "O campo 'idItem' não pode ser nulo")
    private Long idItem;
    ...
    @NotNull(message = "O campo 'despesaFamiliar' não pode ser nulo")
    private Boolean despesaFamiliar;
